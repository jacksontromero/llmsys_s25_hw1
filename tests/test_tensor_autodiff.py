...
def test_topo_case1() -> None:
    # Test case 1
    a1, b1 = tensor([[0.88282157]], requires_grad=True), tensor(
        [[0.90170084]], requires_grad=True
    )
...
def test_topo_case2() -> None:
    ...
    a1, b1 = tensor([[0.20914675], [0.65264178]], requires_grad=True), tensor(
        [[0.65394286], [0.08218317]], requires_grad=True
    )
